...
func TestBatchLandingRehearsalOnRealOrigin(t *testing.T) {
	...
	run := &batchRehearsalRun{t: t, seats: map[string]string{}, branchTips: map[string]string{}, expectedBlobs: map[string][]byte{}, now: time.Date(2026, 9, 19, 16, 0, 0, 0, time.UTC)}
	run.requireInputs()
