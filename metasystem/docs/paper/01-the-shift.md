...
The historical ladder establishes only that bounded work can move into tools. Iterative tool use makes a broader construction-and-delivery loop possible. Those premises establish that the loop is possible. They do not say what delivery must contain. Before choosing the machinery, the unresolved question is this: what does software delivery actually require apart from the process inherited to organize it?
