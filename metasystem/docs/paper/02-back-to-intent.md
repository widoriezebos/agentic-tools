...
Finally, experience must change what happens next. A missed boundary may become a stronger check. A confusing request may lead to a better way of stating success. A rule that produces false refusals may need revision or removal. That is 'learning': improving intent, construction, verification and care from recorded experience. It also develops the people whose judgment the work requires. Delegating construction changes how those people gain experience; in Chapter 14 we will examine how the system can help them learn.
