...
We will develop these principles in the chapters ahead: their mechanisms, their limits and the arguments against them. Here we state them briefly, so the machinery can be judged against a small set of purposes rather than a collection of inherited steps.
