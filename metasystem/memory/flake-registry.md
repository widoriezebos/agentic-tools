...
| missionrunner/TestTerminateGroupLeaksNoGroupsUnderCompression | adopt-fixtures frozen gate (full race+coverage go gate) | 2 | 2026-09-06 | second sighting (first 2026-08-31 in the governed discharge, goal missionrunner-terminate-flake, approved and parked cold-resumable): "(10.48s)" under the same load as the row above; solo rerun green | fix goal already open: missionrunner-terminate-flake |
