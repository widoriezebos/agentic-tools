...
- Concluded: Landed at a7bf3a10 through the tier-1 lane (chain snu-build1, MECHANICAL, receipt go test ./internal/channel/): ComposeReport takes Next up from the goals this machine holds a claim on (goal.Next's Claimed list, at most two) instead of the ready frontier, and drops the line entirely when the post carries no Delivered line; two test cases pin the unclaimed-ready and the claimed-but-undelivered shapes beside the existing report test. The seat's own status post is the live proof from the next landing on.
...
- 2026-09-07T01:30:53Z H942RQSMTDBSS1Y4D42GZ786G7-m1c-7cd0bd60 done actor=m1c+main-1788680061-17829-64951c targets=status-next-up-only-when-claimed
Integrity: sha256=6e3349374ccff868aabb97f4cb428e17b1989299df09fb66cec76c56c1d5e62b
