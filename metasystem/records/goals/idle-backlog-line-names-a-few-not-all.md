...
- Concluded: Landed at 43a88351 (chain ibl-build1, MECHANICAL): the idle-with-backlog line names the count and at most five claimable goals, this machine's pinned goals first and then queue order, with 'and N more (metasystem goal list names them all)' when more remain; ClaimableBudgetedWork carries each claimable goal's pinned machine; refusal counting, block source, digest and the escalation at three are untouched; one test pins the seven-goal and three-goal shapes; goal, steward and report packages green seat-side, engine rebuilt and re-armed (generation 14). The next Stop refusal on this seat is the live proof.
...
- Sliced: machine=m1c lineage=main-1788680061-17829-64951c revision=3 at=2026-09-06T20:36:25Z
...
- 2026-09-06T21:00:36Z HTYRKZWM45Y8SDPK2XJPAEAWRJ-m1c-7cd0bd60 done actor=m1c+main-1788680061-17829-64951c targets=idle-backlog-line-names-a-few-not-all
Integrity: sha256=7849ca7869d5867d60bd34ded35c98f4f0710d50409c4ca76a14043e26df2b73
