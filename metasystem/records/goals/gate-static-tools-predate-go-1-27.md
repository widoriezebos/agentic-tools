...
- Concluded: Landed at 73900f1b through chain gate-go127-build1 (Codex Sol, mechanical reach, the orchestrator's gate as the examination). The gate pins Staticcheck 2026.2 (module v0.8.0), the first release that reads Go 1.27 export data; govulncheck stays at v1.1.4, proven under Go 1.27.1; the gate prints the effective Go and the GOTOOLCHAIN setting before its static stages; go.mod's minimum is go 1.27 with no toolchain directive, per Wido's word that the fleet runs a minimum, never a pin (the VM was upgraded to 1.27.1 the same day). Proof: the fast gate passed on this Mac with no toolchain pin in the environment, and the landing's own static re-proof ran the same way. The stopgap of exporting GOTOOLCHAIN for landings is retired. Goal go-toolchain-pinned-in-go-mod was superseded by m1 under the same word.
...
- 2026-09-06T15:58:53Z EGJXEZ8Y65C9X5V7988RNFW2ZH-m1b-c6925449 done actor=m1b+main-1788680071-18713-e76d5d targets=gate-static-tools-predate-go-1-27
Integrity: sha256=11bf4fae81ef24ffcf9d7301d199c74587a122b61618d3d35b46246775629e69
