...
- Concluded: Dispatch admission no longer refuses a dispatch for goal B because the same lineage holds a breach-stopped goal A: the machine-wide claim scan in EvaluateGoalAdmission skips fenced claims, and dispatch against the fenced goal itself stays refused by the per-goal revision admission with its stop id and live stop reason. Built as round 7 of chain bsws-build1b-20260909 (goal breach-stop-wedges-seat) from finding BSW-12 of that chain's third read, moved into its own file in round 8 when trunk created admission_test.go at the same path, read by bsws-crit5-20260910 and bsws-crit6-20260910 under this goal's budget because the parent goal was at the three-read ceiling of R-42-m0, and proven live by bsws-verify1b-20260910 (a dispatch on the sibling goal started while the fenced goal was held; the fenced goal's own dispatch refused). Landed with that chain. Nothing is left on this goal; the carried-fold record is records/misc/dispatch-admission-fenced-sibling-carried-fold.md.
...
- 2026-09-10T12:28:43Z 79HPFKV2JWBSQR9YTFY7TH0X1P-m1d-8651d169 done actor=m1d+main-1788941004-20871-67f3a0 targets=dispatch-admission-refuses-on-a-fenced-sibling
Integrity: sha256=d560316484d9395fb53500ba36c9ae00754d4f4d0d044d314f9e5f5b8a49c428
