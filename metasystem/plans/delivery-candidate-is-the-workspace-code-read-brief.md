...
FINDING IDS: chain-unique, DCW-14, DCW-15, ... never F-n.
...
final work round 2 (job dcwl-build2-20260910-r2), reviewed tree 32c57bfd75329926b6312da3713b00dda014a010, rebased onto
...
Write your register as this new file: `metasystem/records/misc/delivery-candidate-is-the-workspace-code-read-r1.md`
...
Findings by id (DCW-14 onward) with the file and line in the reviewed
...
is, or one fold naming which findings. Wall-clock budget: 45 minutes.
