...
# Review brief: the terminal grade for stopping acts after the tenth round (chain hp-terminal-build1-20260909, reviewing round hp-terminal-build1-20260909-r10)

FINDING IDS: chain-unique, continue the chain's sequence at HPT-26,
never F-n and never a reused id. Report `round` as 1 in your return:
it is this job's own round. You are the eighth critic on this chain.
...
Scope: the computed diff of round hp-terminal-build1-20260909-r10 (the
...
hp-terminal-build1-20260909-r10; if your sandbox cannot run it, read the
