...
# Review brief: reservation caps settle to the minutes a job ran (chain dispatch-cap-build1-20260909, reviewing round dispatch-cap-build1-20260909-r3)

FINDING IDS: chain-unique, continue the chain's sequence at DCN-06, never F-n. You are the second critic on this chain. Report `round`
...
dispatch-cap-build1-20260909-r3; if your sandbox cannot run it, read the
