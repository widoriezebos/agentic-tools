...
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
| HOST-D3-001 | HIGH | Final design critique | Devin repair children receive authenticated delegate context and cannot mutate coordinator state | shared adapter launch setup and Devin adapter | scripts/agents/adapters/runtime-common.sh and scripts/agents/adapters/devin.sh | scripts/agents/runtime-hook-fixtures.sh: TestDevinDeliveryRepairHookIsolation | force actual secondary launch in linked worktree and shared checkout; compare all coordinator/session state | MISSING | Implement correction, run fixture, obtain independent code critique |
