...
Orchestrator Identity: m1d (lineage main-1788941004-20871-6e7a43, dispatch delegate under goal delivery-candidate-is-the-workspace-not-the-ledger, live proof of chain dcwl-build2-20260910, final work round 2)
Date: 2026-09-10
...
4. Clone two instead appends a comment to `scripts/agents/coverage-delta.sh`;
   clone one's landing refuses, `land.out` carries
   `proof-input-moved-after-receipt`, the group id and that path, and
   origin's `main` is still B.
...
- The chain's engine, built from the reviewed round-2 tree 32c57bfd75329926b6312da3713b00dda014a010, is
  at /private/tmp/claude-501/-Users-wido-LocalStorage-GitHub-agentic-tools-m1d/1256ce4b-2cff-499e-9e81-ed1cf7deb77a/scratchpad/dcwl-proof-engine. Use it as METASYSTEM_BIN and as the binary you invoke
...
exit code, never from a wrapper. Each of the six behaviours is one
