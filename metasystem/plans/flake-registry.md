...
| acp turn late-window traffic | acp go test | 1 | 2026-08-24 | TestTurnLateWindowTraffic expected a post-window permission-request violation and saw none, once, during the custody slice-one full suite; untouched package, timing-shaped window test; solo rerun -count=3 green |
