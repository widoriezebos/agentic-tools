...
names, a new file in the records directory under misc, named for this goal and critique round two.

The design is metasystem/plans/proof-groups-detect-hangs-by-progress-not-the-clock-design.md,
