...
| 31 | tests-never-wait-on-wall-time | D | new 2026-09-14: a one-second wall-clock guard in a test went red under load on unchanged code | 2 | delegate loop |
| 32 | stop-decision-surface-is-a-gate | D | new 2026-09-14 from m1c: a build quietly inverted two Stop allowances and only a scratchpad script caught it; the guard moves into the gate; approved at priority 1 under Wido's standing word of 2026-09-14 | 3 | delegate loop |
| 33 | beds-run-under-the-oldest-supported-bash | D | new 2026-09-14 from m1c, beside 24: an empty array under set -u, rejected by macOS bash 3.2, killed a whole bed at start; same class as stop-decisions round 21; approved at priority 1 under Wido's standing word of 2026-09-14 | 2 | delegate loop |
| 34 | degraded-stop-forms-have-one-source | D | new 2026-09-14 from m1c, beside 25: the hook's degraded texts are copied as literals across beds; three rounds lost to it; same class as stop-decisions rounds 14 and 16; approved at priority 1 under Wido's standing word of 2026-09-14 | 2 | delegate loop |
| 35 | go-tests-never-inherit-a-candidate-engine | D | new 2026-09-14 from m1c: an exported METASYSTEM_BIN faked a pre-commit guard failure in a Go test; approved at priority 1 under Wido's standing word of 2026-09-14 | 2 | delegate loop |
| 36 | testing-surfaces-declare-their-mirror | C | new 2026-09-14 from m1c: a proof group added to the fallback surface but not mirrored on context-budget, caught only by a failing test; approved at priority 1 under Wido's standing word of 2026-09-14 | 2 | verification |
| 37 | every-verb-resolves-repo-to-an-absolute-root | C | new 2026-09-14 from m1c: health on a relative --repo reported false corruption and BUDGET_UNKNOWN; approved at priority 1 under Wido's standing word of 2026-09-14 | 2 | verification |
| 38 | stop-capability-follows-the-lease-epoch | C | new 2026-09-14 from m1c: lease claimEpoch 5 against a goal StopCapability of 1 locked a seat out of proving its own goal; approved at priority 1 under Wido's standing word of 2026-09-14 | 3 | verification |
...
Phase D, the delegate loop, was added on 2026-09-14 from the stop-decisions-record-deadline-evidence build, which took nineteen rounds for one member: every bed-visible defect cost a round trip through the seat because the delegate could not run the beds, three rounds repaired the previous round's own blind change, and the beds report one failure per run. Wido's word the same day: these are efficiency improvements, added to this program and done with priority. Order: 22 first, because it removes the blindness that causes the rest; 23 next, because it removes the seat from the loop; 24 and 25 are independent; 26 and 27 are gates that stop the next oversized member before it is built. Later the same day Wido asked for structural fixes, not workarounds: 22 became a declared sandbox contract (the adapter probe answers what the sandbox allows, each bed declares what it needs, the dispatcher assigns each bed to the delegate or to the seat's proof), 23 has the engine compose the follow-up brief from the findings record so the seat is never a relay, and 31 was added after a wall-clock test guard flaked under load. Rows 32 to 38 were added the same evening from goals m1c opened in Wido's name when he asked for structural fixes; each turns one defect class seen on 2026-09-14 into a mechanism with a fixture that reproduces the incident. They are queued and unranked until he approves and orders them. Wido's standing word the same evening: every goal created new as part of this program is approved on creation and carries the program's top priority, priority 1, like the rest of the efficiency work; rows 22 to 27 and 31 to 38 were approved and ranked at priority 1 that evening, and any seat that opens a new efficiency goal approves and ranks it the same way in his name.
