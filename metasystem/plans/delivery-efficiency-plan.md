...
| 32 | stop-decision-surface-is-a-gate | D | new 2026-09-14 from m1c: a build quietly inverted two Stop allowances and only a scratchpad script caught it; the guard moves into the gate; queued and unranked, awaiting Wido's approval | 3 | delegate loop |
| 33 | beds-run-under-the-oldest-supported-bash | D | new 2026-09-14 from m1c, beside 24: an empty array under set -u, rejected by macOS bash 3.2, killed a whole bed at start; same class as stop-decisions round 21; queued and unranked, awaiting Wido's approval | 2 | delegate loop |
| 34 | degraded-stop-forms-have-one-source | D | new 2026-09-14 from m1c, beside 25: the hook's degraded texts are copied as literals across beds; three rounds lost to it; same class as stop-decisions rounds 14 and 16; queued and unranked, awaiting Wido's approval | 2 | delegate loop |
| 35 | go-tests-never-inherit-a-candidate-engine | D | new 2026-09-14 from m1c: an exported METASYSTEM_BIN faked a pre-commit guard failure in a Go test; queued and unranked, awaiting Wido's approval | 2 | delegate loop |
| 36 | testing-surfaces-declare-their-mirror | C | new 2026-09-14 from m1c: a proof group added to the fallback surface but not mirrored on context-budget, caught only by a failing test; queued and unranked, awaiting Wido's approval | 2 | verification |
| 37 | every-verb-resolves-repo-to-an-absolute-root | C | new 2026-09-14 from m1c: health on a relative --repo reported false corruption and BUDGET_UNKNOWN; queued and unranked, awaiting Wido's approval | 2 | verification |
| 38 | stop-capability-follows-the-lease-epoch | C | new 2026-09-14 from m1c: lease claimEpoch 5 against a goal StopCapability of 1 locked a seat out of proving its own goal; queued and unranked, awaiting Wido's approval | 3 | verification |
