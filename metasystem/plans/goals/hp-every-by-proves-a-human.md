# hp-every-by-proves-a-human

- State: approved
- Risk: severity=3 novelty=2 exposure=3 accumulation=2 basis="severity 3: it closes the route by which an agent with an exported lineage performs human-only acts, the one thing the authority layer exists to prevent; novelty 2: one builder change plus proof plumbing on routes that bypass it; exposure 3: every human act on every seat; accumulation 2: every future verb inherits the rule or reopens the hole"
- Tier: 3
...
- BudgetExceptions: 0
- Approved: by=human:Wido at=2026-09-09T14:36:28Z revision=2 opid=76XV3QEKM1Y759NSDZ4GYEH9R3-m1-c6925449 authority=proven digest=2bf783d4d8beec8920721cb744af46453312d50d5f9c3b3c31e62db210fb22f2
