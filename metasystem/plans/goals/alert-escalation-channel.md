...
- Origin: human
- Next step: Appetite: 3h — design then build. PROMOTED by Wido's word 2026-08-31 evening ("all approved") from back-of-backlog to next-up priority; the 2026-08-29 back-queue ordering is superseded. DRIVING SPECIMEN (records/misc/idle-loss-2026-08-31.md): three hours lost while a seat sat blocked on Wido's word and nine stalled-idle steward escalations terminated in a git-landed log he never saw - detection existed, delivery did not. The channel: separate from narrative delivery (alerts must never drown in digest noise), carrying the Ruling L escalation classes (ended auto-heal, no lawful remedy, flapping) PLUS every blocked-on-human state as a first-class alert - a claim awaiting approval, a stop awaiting resume, a genesis acceptance, a decision-ask with no human at the terminal; each alert names what is asked and the exact command or act that answers it; delivery receipts and the agent-free-terminal acknowledgment per Ruling G (health acknowledge-alert is the existing seam); the alert episode store (L4) is the source of truth - the channel is transport, never a second state; fallback when the channel is down: the phone/desktop path and the stop-message floor
- OpenedAt: 2026-08-29T06:19:06Z
- Revision: 5
- Budget: elapsedLimit=4h attemptLimit=3 reservedJobMinutesLimit=90 activeJobLimit=1
- Claimed: machine=m3 lineage=mac-m3 at=2026-08-31T19:59:51Z revision=5
...
Integrity: sha256=09f3541c4adbadf09501a6587ed1ff986d8b651cb2b86e42cf3986d7bc3674cd
