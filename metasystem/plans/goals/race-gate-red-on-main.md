...
- Origin: main
- Next step: m2's evidence landed (records/misc/race-gate-m2-evidence-2026-09-06.md, 7eb1ab9b). The 2026-09-04 steward failure text is lost with that session's scratchpad; the surviving grep line shows the steward test itself took 8.86s and the package total was 1042s, so 'failed after 1042 seconds' in the intent conflated the two. The test passed on m2 today (6.83s, package green at 683s) and in three configurations on m1; four runs, no recurrence, no failure text: it cannot be fixed at cause and the intent's steward clause cannot be met as written. m2 fresh gate (16 cores, 32 GiB, Intel): goal 1678s and missionrunner 1476s under race+cover, nothing near the new 60m ceiling, both red on the same two data races the chain fixes; missionrunner also red on TestTerminateGroup (owned group survived wind-down), the flake family owned by goal missionrunner-terminate-flake; TestNestedCheckoutMissionBirth also failed in the lost 09-04 run. Seat state: chain rgr-build1 closed, landing receipt running in a detached worktree (the live-root receipt races the narrator, goal landing-receipt-races-the-narrator-digest), landing via commit.sh --chain --test-receipt (land.sh gap, goal land-sh-omits-the-full-width-chain-receipt), then the adopt fixture as proof. Wido's decision: narrow the intent to what is proven (refusal fix, two goal races, ceiling, adopt fixture green) and drop or split the steward clause, or keep it and park.
...
Integrity: sha256=3147dbc1770cedcc147c2cc31027e933dd6b0e83d85dadfc31f39847d553a2d6
