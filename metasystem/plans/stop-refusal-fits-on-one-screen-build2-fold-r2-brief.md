...
# Fold brief: round two of the allow path and the health line (chain one-screen-build2b-20260909)

You built round one. The critic one-screen-build2-crit1-20260909 found
two material defects and three notes, and the orchestrator's seat-side
gate found the new template-layout fixture dying silently. The
...
(new, not yet committed). Fold the four items below into the same
worktree; touch nothing outside the eight files of round one.
