...
This file supersedes plans/follow-up-rebase-fold2-brief.md, which named the
two files round 1 created with the repository prefix. Admission checks a
cited path against the worktree HEAD commit, and a round-created file is
not in it; those two paths are written without the prefix here. They are
internal/dispatch/followup_rebase.go and internal/dispatch/followup_rebase_test.go
in the worktree, uncommitted, exactly as round 1 left them.
...
D8. In internal/dispatch/followup_rebase.go, a round without
...
internal/dispatch/followup_rebase_test.go: a round with a
...
internal/dispatch/followup_rebase.go,
internal/dispatch/followup_rebase_test.go,
