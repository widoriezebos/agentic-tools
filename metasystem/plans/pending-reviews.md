# Reviews waiting for a reviewer, 2026-09-02 evening

Each line is one design or analysis on main that has its reviewer
instructions ready and waits for a seat with a free claim slot. Claim the
goal, fill the identity line of the brief with your callsign and session
main, land the brief, dispatch the design-critic, land the register under
records/misc, then follow the goal's next step. Any seat may take any
line; the ledger claim is the only lock. Since 17:49 the Codex handshake
budget is 30 seconds, so every seat including m1 can run these.
