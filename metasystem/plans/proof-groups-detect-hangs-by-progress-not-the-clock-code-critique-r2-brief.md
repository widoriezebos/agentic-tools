...
FINDING IDS: chain-unique, continue from PHD-08 (PHD-01 to PHD-07 were
the first critique's, phd-build1-crit2-20260910 on round 6; the
dispositions record lands with the chain and its decisions are on the
design page under "Build decisions"); never F-n. Report `round` as 1 in your return: it is this job's own
round. One focused round: verify the fold of the seven findings first,
then attack what rounds 7 and 8 changed (round 8: real-reader rows carry
