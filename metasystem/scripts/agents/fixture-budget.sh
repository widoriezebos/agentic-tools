...
# Owns bounded, load-scaled ceilings for process-backed metasystem fixtures.
...
try:
    ...
    raise SystemExit("METASYSTEM_FIXTURE_CAP_SCALE must be a decimal from 0.01 through 20")
