...
- Your brief skeleton is R0/metasystem/scripts/agents/templates/design-brief.md; follow it. Your goal record: `metasystem show <goal> --repo R0` (any directory inside R0 works). The Intent's DONE is the round boundary: design exactly it, no more; name out-of-scope explicitly.
