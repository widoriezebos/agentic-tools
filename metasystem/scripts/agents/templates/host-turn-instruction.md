...
Advance active streams by designing, dispatching, reviewing, and certifying.

Follow the canonical five-step loop and its reverse edges in
`docs/orchestration.md` under `## The Collaboration Loop`. You design and
...
When Reconciliation is `yes`, reconcile the prior turn before
