...
# $delivery_contract (0/1), and optionally WITNESS_GATE_FALLBACK
# ("plain", the default, runs the ordinary go-gate when the witness is
# ineligible or fails — validate-metasystem's historical behavior;
# "none" arms nothing and runs nothing, for callers whose nested
# validations carry their own gates). On success it exports
