...
export const HELP: Record<HelpId, Term> = {
  ...
  sittings: {
    term: "Sittings",
    text:
      "The records this project has sat on, newest first: what each sitting recorded into its record, how much of each pile it holds, when its last entry was written, and whether a sitting stands on it right now. It is a view over those records and not a second store — a record is here because its own entries say a sitting put them there. Opening a row takes you to the conversation on that record, and starts a sitting on it where none stands; the press is your consent to that.",
  },
  "no-recommendation": {
