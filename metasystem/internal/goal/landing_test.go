...
func TestOwnPairLeavesKeepTheEpisodeOnEveryPath(t *testing.T) {
	...
	if res, err := OpenRisked(landingReqFor(a, "01J5X00000000000000000NK12", "mac-a", blockAt), "fix-h", "The defect that blocks held-h.", OriginMain, "Fix it.", "held-h", risk, 0, "", &budget, nil); err != nil || res.Outcome != OutcomeConfirmed {
