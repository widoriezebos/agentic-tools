...
func TestSplitMovesABlockerParkToTheFirstMember(t *testing.T) {
	...
	if res, err := OpenRisked(verbReqFor(endpoint, "01J5X00000000000000000SP02", "mac-a"), "split-parent", "A large blocker.", OriginMain, "Decompose it.", "held", risk, 0, "", &budget, nil); err != nil || res.Outcome != OutcomeConfirmed {
