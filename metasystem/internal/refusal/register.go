...
var Rows = []Row{
	...
	{Code: "TEST_POLICY_COVERAGE_FLOOR_LOWERED", Owner: "cmd/metasystem", Site: "test.go:845", Shape: Question},
	...
	{Code: "proof-input-moved-after-receipt", Owner: "cmd/metasystem", Site: "test.go:2284", Shape: Agent, Override: "reset to the pushed tip, re-stage, landing test-receipt --mode auto, land again", Commands: 4},
