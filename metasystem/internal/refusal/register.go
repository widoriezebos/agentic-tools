...
var Rows = []Row{
	...
	{Code: "record-writer-refused", Owner: "cmd/metasystem", Site: "intent_delivery.go:1702", Shape: Agent, Override: "review --dispositions", Commands: 1},
	{Code: "UNIT_REVISION_CONFLICT", Owner: "cmd/metasystem", Site: "intent_selection.go:687", Shape: Question},
	...
	{Code: "UNIT_ROUND_LIMIT", Owner: "cmd/metasystem", Site: "intent_selection.go:693", Shape: Agent, Override: "budget", Commands: 1},
	...
	{Code: "GOAL_CLAIM_QUOTA", Owner: "internal/goal", Site: "verbs.go:1289", Shape: Question},
	{Code: "REBIND_EPOCH_UNAUTHENTICATED", Owner: "internal/goal", Site: "verbs.go:261", Shape: Identity},
	{Code: "SET_BUDGET_FENCED_SAME_TUPLE", Owner: "internal/goal", Site: "verbs.go:1645", Shape: Question},
	...
	{Code: "REDUNDANT_READ", Owner: "internal/dispatch", Site: "read_admission.go:259", Shape: Agent, Override: "dispatch.sh close --job <prior critic root>", Commands: 1},
