...
var Rows = []Row{
	...
	{Code: "TEST_POLICY_ENGINE_REQUIRED", Owner: "cmd/metasystem", Site: "test.go:356", Shape: Agent, Override: "the run: command of the line's cause (internal/enginecause.Table)", Commands: 6},
