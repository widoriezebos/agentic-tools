...
var Rows = []Row{
	...
	{Code: "HANDOFF_HUMAN_UNPROVEN", Owner: "internal/steward", Site: "handoff_capture.go:1053", Shape: Identity},
	{Code: "HANDOFF_LAUNCH_IN_FLIGHT", Owner: "internal/steward", Site: "handoff_capture.go:472", Shape: Question},
	{Code: "HANDOFF_NOT_FOUND", Owner: "internal/steward", Site: "handoff_capture.go:1205", Shape: Question},
	{Code: "HANDOFF_NOT_HOLDER", Owner: "internal/steward", Site: "handoff_capture.go:287", Shape: Question},
	{Code: "HANDOFF_NOT_LIVE", Owner: "internal/steward", Site: "handoff_capture.go:1124", Shape: Question},
	{Code: "HANDOFF_NO_GOAL", Owner: "internal/steward", Site: "handoff_capture.go:361", Shape: Question},
	{Code: "HANDOFF_OTHER_SESSION", Owner: "internal/steward", Site: "handoff_capture.go:1074", Shape: Agent, Override: "metasystem context handoff --root <installation> --cancel <nonce> --by <human>, typed at an enrolled or agent-free terminal", Commands: 1},
	{Code: "HANDOFF_OTHER_PENDING", Owner: "internal/steward", Site: "handoff_capture.go:956", Shape: Question},
	{Code: "HANDOFF_REFERENCE", Owner: "internal/steward", Site: "handoff_capture.go:231", Shape: Question},
	{Code: "HANDOFF_STATE_MISMATCH", Owner: "internal/steward", Site: "handoff_capture.go:1237", Shape: Question},
	{Code: "HANDOFF_STATE_TOO_LARGE", Owner: "internal/steward", Site: "handoff_capture.go:795", Shape: Question},
	{Code: "HANDOFF_UNOBSERVABLE", Owner: "internal/steward", Site: "handoff_capture.go:316", Shape: Question},
	{Code: "HANDOFF_WAIT_IN_FLIGHT", Owner: "internal/steward", Site: "handoff_capture.go:415", Shape: Question},
