...
var Rows = []Row{
	...
	{Code: "UNIT_FOLLOW_UP_MISSING", Owner: "internal/launch", Site: "unit_run.go", Shape: Question},
	...
	{Code: "BATCH_JOIN_CONFLICT", Owner: "internal/landing/batch", Site: "join.go", Shape: Question},
	...
	{Code: "BATCH_SEAL_CHANGED_DURING_GATE", Owner: "internal/landing/batch", Site: "seal.go", Shape: Question},
	...
	{Code: "BATCH_OWNER_IDENTITY_UNKNOWN", Owner: "cmd/metasystem", Site: "landing_batch_owner.go", Shape: Question},
	{Code: "BATCH_OWNER_INDETERMINATE", Owner: "cmd/metasystem", Site: "landing_batch_owner.go", Shape: Question},
	{Code: "BATCH_OWNER_OWNED_ELSEWHERE", Owner: "cmd/metasystem", Site: "landing_batch_owner.go", Shape: Question},
	{Code: "CADENCE_OWNER_UNCONFIGURED", Owner: "cmd/metasystem", Site: "gate_cadence.go", Shape: Question},
	{Code: "CADENCE_NOT_LANDING_OWNER", Owner: "cmd/metasystem", Site: "gate_cadence.go", Shape: Question},
	{Code: "CADENCE_FETCH_REFUSED", Owner: "cmd/metasystem", Site: "gate_cadence.go", Shape: Question},
	{Code: "CADENCE_LEDGER_UNREADABLE", Owner: "cmd/metasystem", Site: "gate_cadence.go", Shape: Question},
	{Code: "BATCH_PROOF_INPUT_MOVED", Owner: "internal/landing/batch", Site: "prove.go", Shape: Question},
	{Code: "BATCH_PROOF_NOT_ADMITTED", Owner: "internal/landing/batch", Site: "prove.go", Shape: Question},
	{Code: "BATCH_PROOF_STATE_REFUSED", Owner: "internal/landing/batch", Site: "prove.go", Shape: Question},
	{Code: "BATCH_PROOF_UNION_UNCOVERED", Owner: "internal/landing/batch", Site: "prove.go", Shape: Question},
	{Code: "BATCH_REOPEN_SAME_TREE", Owner: "internal/landing/batch", Site: "reopen.go", Shape: Question},
	{Code: "BATCH_LANDING_BRANCH_MOVED", Owner: "internal/landing/batch", Site: "transport.go", Shape: Question},
	{Code: "BATCH_LANDING_BRANCH_PREP_REFUSED", Owner: "internal/landing/batch", Site: "transport.go", Shape: Question},
	{Code: "BATCH_LAND_AUTHOR_UNBOUND", Owner: "internal/landing/batch", Site: "transport.go", Shape: Question},
	{Code: "BATCH_LAND_CLEANUP_REFUSED", Owner: "internal/landing/batch", Site: "transport.go", Shape: Question},
	{Code: "BATCH_LAND_COMMIT_REFUSED", Owner: "internal/landing/batch", Site: "land.go", Shape: Question},
	{Code: "BATCH_LAND_DELEGATION_REFUSED", Owner: "internal/landing/batch", Site: "land.go", Shape: Question},
	{Code: "BATCH_LAND_HELD_REFUSED", Owner: "internal/landing/batch", Site: "land.go", Shape: Question},
	{Code: "BATCH_LAND_PUSH_REFUSED", Owner: "internal/landing/batch", Site: "transport.go", Shape: Question},
	...
	{Code: "TRUNK_RED_UNKNOWN", Owner: "internal/goal", Site: "trunkred.go:499", Shape: Question},
	{Code: "TRUNK_RED_CLOSED", Owner: "internal/goal", Site: "trunkred.go:505", Shape: Question},
	{Code: "TRUNK_RED_FIX_GOAL_UNKNOWN", Owner: "internal/goal", Site: "trunkred.go:555", Shape: Question},
	{Code: "TRUNK_RED_OWNED_ELSEWHERE", Owner: "internal/goal", Site: "trunkred.go:559", Shape: Agent, Override: "goal trunk-red own --by", Commands: 1},
	{Code: "TRUNK_RED_CLOSE_IS_HUMAN", Owner: "internal/goal", Site: "trunkred.go:592", Shape: Agent, Override: "goal trunk-red close --by --why", Commands: 1},
	...
	{Code: "HANDOFF_DELEGATES_UNDECLARED", Owner: "cmd/metasystem", Site: "context_verbs.go", Shape: Question},
	{Code: "HANDOFF_DELEGATE_INCOMPLETE", Owner: "cmd/metasystem", Site: "context_verbs.go", Shape: Question},
	{Code: "HANDOFF_DELEGATE_OUTPUT_MISMATCH", Owner: "cmd/metasystem", Site: "context_verbs.go", Shape: Question},
	{Code: "HANDOFF_DELEGATE_UNDECLARED", Owner: "cmd/metasystem", Site: "context_verbs.go", Shape: Question},
	{Code: "HANDOFF_DELEGATE_UNKNOWN", Owner: "cmd/metasystem", Site: "context_verbs.go", Shape: Question},
	{Code: "HANDOFF_LAUNCH_IN_FLIGHT", Owner: "internal/steward", Site: "handoff_capture.go:502", Shape: Question},
	{Code: "HANDOFF_NOTE_LACKS_OUTPUT", Owner: "internal/steward", Site: "handoff_capture.go", Shape: Question},
	{Code: "HANDOFF_NOTE_MISSING", Owner: "internal/steward", Site: "handoff_capture.go", Shape: Question},
	{Code: "HANDOFF_NOTE_OUTSIDE_MEMORY", Owner: "internal/steward", Site: "handoff_capture.go", Shape: Question},
	{Code: "HANDOFF_NOTE_STALE", Owner: "internal/steward", Site: "handoff_capture.go", Shape: Question},
	...
	{Code: "HANDOFF_TASKS_IN_FLIGHT", Owner: "cmd/metasystem", Site: "context_verbs.go", Shape: Question},
	...
	{Code: "GOAL_BRANCH_UNAVAILABLE", Owner: "internal/goal/branch", Site: "commit.go", Shape: Question},
	{Code: "GOAL_BRANCH_NOT_HOLDER", Owner: "internal/goal/branch", Site: "commit.go", Shape: Question},
	{Code: "GOAL_BRANCH_CHECKOUT_ARMED", Owner: "internal/goal/branch", Site: "commit.go", Shape: Question},
	{Code: "GOAL_BRANCH_LEASE_MOVED", Owner: "internal/goal/branch", Site: "push.go", Shape: Question},
	{Code: "GOAL_BRANCH_CLAIM_LOST", Owner: "internal/goal/branch", Site: "push.go", Shape: Question},
	{Code: "GOAL_BRANCH_PUSH_UNKNOWN", Owner: "internal/goal/branch", Site: "push.go", Shape: Question},
	{Code: "GOAL_BRANCH_STALE", Owner: "internal/goal/branch", Site: "push.go", Shape: Question},
	{Code: "GOAL_PARK_UNPUSHED", Owner: "internal/goal/branch", Site: "status.go", Shape: Question},
	{Code: "GOAL_LAND_PARTIAL", Owner: "internal/goal/branch", Site: "land.go", Shape: Question},
	{Code: "GOAL_UNIT_REREAD", Owner: "internal/goal/branch", Site: "land.go", Shape: Question},
	{Code: "GOAL_LAND_UNPROVEN", Owner: "internal/goal/branch", Site: "land.go", Shape: Question},
	{Code: "GOAL_LAND_RETRY", Owner: "internal/goal/branch", Site: "land.go", Shape: Question},
	{Code: "GOAL_LAND_UNCHECKED", Owner: "internal/goal/branch", Site: "land.go", Shape: Question},
	{Code: "GOAL_LAND_BRANCH_MOVED", Owner: "internal/goal/branch", Site: "land.go", Shape: Question},
	{Code: "GOAL_LAND_TRUNK_MOVED", Owner: "internal/goal/branch", Site: "publish.go", Shape: Question},
	{Code: "GOAL_LAND_VERIFY", Owner: "internal/goal/branch", Site: "verify.go", Shape: Question},
	{Code: "GOAL_LAND_AUTHOR_UNBOUND", Owner: "internal/goal/branch", Site: "land.go", Shape: Question},
	{Code: "GOAL_LAND_TRUNK_RED", Owner: "internal/goal/branch", Site: "red.go", Shape: Question},
	{Code: "GOAL_SWEEP_UNLANDED", Owner: "internal/goal/branch", Site: "sweep.go", Shape: Question},
	{Code: "GOAL_READ_UNGATED", Owner: "internal/goal/branch", Site: "attest.go", Shape: Question},
	{Code: "GOAL_READ_TESTS_UNNAMED", Owner: "internal/goal/branch", Site: "attest.go", Shape: Question},
	{Code: "GOAL_READ_STALE", Owner: "internal/goal/branch", Site: "attest.go", Shape: Question},
	{Code: "GOAL_READ_INVALID", Owner: "internal/goal/branch", Site: "attest.go", Shape: Question},
	{Code: "attested-malformed-id", Owner: "internal/landing", Site: "attested.go", Shape: Question},
	{Code: "attested-unreadable", Owner: "internal/landing", Site: "attested.go", Shape: Question},
	{Code: "attested-invalid", Owner: "internal/landing", Site: "attested.go", Shape: Question},
	{Code: "attested-not-critic", Owner: "internal/landing", Site: "attested.go", Shape: Question},
	{Code: "attested-goal-mismatch", Owner: "internal/landing", Site: "attested.go", Shape: Question},
	{Code: "attested-change-mismatch", Owner: "internal/landing", Site: "attested.go", Shape: Question},
	...
	{Code: "BRIEF_BOUNDS_UNREADABLE", Owner: "internal/validate", Site: "brief_bounds_source.go:21", Shape: Question},
	...
	{Code: "DELEGATE_RECEIPT_REFUSED", Owner: "internal/validate", Site: "conformance.go:715", Shape: Agent, Override: "remove the delegate change to memory/receipts.log, then validate conformance --stage review --job <that round>", Commands: 2},
	{Code: "TEST_POLICY_ENGINE_REQUIRED", Owner: "cmd/metasystem", Site: "test.go:356", Shape: Agent, Override: "the run: command of the line's cause (internal/enginecause.Table)", Commands: 9},
