...
var Rows = []Row{
	...
	{Code: "proof-input-moved-after-receipt", Owner: "cmd/metasystem", Site: "test.go:2291", Shape: Agent, Override: "reset to the pushed tip, re-stage, landing test-receipt --mode auto, land again", Commands: 4},
