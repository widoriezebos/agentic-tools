...
Use [references/investigation-ledger.md](references/investigation-ledger.md) for the task ledger shape. A filled example lives at `docs/examples/step-back-ledger.md` from the harness root.
