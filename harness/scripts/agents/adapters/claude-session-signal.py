...
signal_path = Path(os.environ["HARNESS_CLAUDE_SESSION_SIGNAL"])
events_path = Path(os.environ["HARNESS_CLAUDE_EVENTS"])
...
print(f"Harness runtime session id: {session_id}")
