...
| IL-4b | retro-2026-08-03 (scope extension) | Session-start hooks arm supervision on every runtime; detection is the guarantee, prevention is impossible with shell access | `scripts/enforcement/` | an unarmed session cannot occur on a hook-supporting runtime | UNTRACKED and arming work identically under Claude, Codex, and Devin mains | next retro | ADOPTED |
