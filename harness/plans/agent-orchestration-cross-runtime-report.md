...
The plugin's test suite covers cancellation, nested subagent events, session scoping, compatibility fallbacks, context limits, and malicious arguments. The harness fake should script:
