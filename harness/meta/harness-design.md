...
- User outcome: a reusable, low-noise harness distilled from production engineering repositories, their work records, runtime-debugging practice, and the supplied harness-cleaning transcript.
